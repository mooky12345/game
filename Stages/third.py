...
class third():
    def __init__(self,player_cnt,player_list):
        ...
        self.main_Platform_1 = platform(950, 20, 255, 0, 0, 0, 302, 610)
        self.float_plat_1 = platform(200, 30, 255, 0, 0, 0, 74, 494)
        self.float_plat_2 = platform(170, 30, 255, 0, 0, 0, 675, 320)
        self.float_plat_3 = platform(290, 30, 255, 0, 0, 0, 1167, 360)
        self.bg = background_test(image="background/4.jpg")
